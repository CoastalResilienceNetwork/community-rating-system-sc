        ...
        return declare(null, { 
        	eventListeners: function(t){
				...
				$('#' + t.id + 'futurePDF').on('click', function(){
					window.open("https://crs-maps.coastalresilience.org/" + t.obj.crsNoSpace + "SC_Future_" + t.pin + ".pdf", "_blank");					
				});
				...
				$('#' + t.id + 'futureTop50').on('click', function(){
					window.open("https://crs-maps.coastalresilience.org/" + t.obj.crsNoSpace + "SC_Future_Parcel_Table.zip", "_blank");					
				});
